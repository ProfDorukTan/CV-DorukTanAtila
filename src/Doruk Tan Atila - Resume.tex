...
%--------------------------------------------------------------------------------------%
\objective{Electronic engineering graduate with 1st Class Honours, various projects and research experiences. \\
    Passionate about \tech{hardware design} and \tech{embedded
        systems}  with a niche interest in \tech{neuromorphic
        computing}.}
...
\experience{Bachelor of Engineering}{Electronic Engineering}{Sept 2021}{December 2024}{
    \noindent The University of Manchester, Manchester, UK \hfill 1st Class Honours
    \achievement{Relevant coursework: Digital System
...
\experience{Organic Phototransistor Array for Infrared Imaging}{Coursework}{May 2024}{May 2024}{
    \achievement{
        Designed an organic phototransistor array for infrared imaging
        using a conjugated polymer from literature, incorporating filter
        arrays to detect NIR, SWIR, MWIR, and broadband wavelengths for
        precise detection of specific infrared bands.
    }
    \achievement{
        Skills: \tech{Sensor Design}, \tech{Signal Conditioning},
        \tech{Imaging Sensors}
    }
}
\experience{Cache Simulator}{Coursework}{Apr 2024}{Apr 2024}{
    \achievement{
        Coded a cache simulator capable of simulating given memory trace file
        for different cache configurations.
    }
    \achievement{
        Skills: \tech{C}, \tech{Cache}, \tech{Simulation}
    }
}
\experience{Concurrent Systems}{Coursework}{Nov 2023}{Nov 2023}{
    \achievement{
    ...
    \achievement{
        Skills: \tech{C++}, \tech{Multithreading}, \tech{Simulation}
    }
}
\experience{Microcontroller-Peripheral Communication I2C/SPI}{Coursework}{Nov 2023}{Nov 2023}{
    \achievement{
...
\achievement{
    Programming Languages: Verilog, VHDL, Assembly, C, C++, Python, CUDA, MATLAB with Simulink,
    Mbed, SQL
}
\achievement{
